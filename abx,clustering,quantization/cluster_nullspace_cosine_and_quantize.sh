...
setsToProcess=\
"${LibriSpeechPath}/train-clean-100,${saveThingsPath}/nullspace_cosine_cosine_quantizations/LibriSpeech/train-clean-100,32,${LibriSpeechFormat} \
${LibriSpeechPath}/train-full-960,${saveThingsPath}/nullspace_cosine_cosine_quantizations/LibriSpeech/train-full-960,32,${LibriSpeechFormat} \
